...
public class DailyActivityFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dailyList.add(new DailyActivityModel("Bangun Tidur"));
        dailyList.add(new DailyActivityModel("Ngampus"));
        dailyList.add(new DailyActivityModel("Istirahat"));
        dailyList.add(new DailyActivityModel("Main Games"));
        dailyList.add(new DailyActivityModel("Tugas"));
    }
