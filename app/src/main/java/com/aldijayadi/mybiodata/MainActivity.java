...
import com.aldijayadi.mybiodata.Fragments.DailyActivityFragment;
import com.aldijayadi.mybiodata.Fragments.GalleryFragment;
import com.aldijayadi.mybiodata.Fragments.HomeFragment;
import com.aldijayadi.mybiodata.Fragments.InterestFragment;
import com.aldijayadi.mybiodata.Fragments.MusicVideoFragment;
import com.aldijayadi.mybiodata.Fragments.ProfileFragment;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        int id = item.getItemId();
         ...
         if (id == R.id.nav_gallery) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.itscontainer, new InterestFragment()).commit();
